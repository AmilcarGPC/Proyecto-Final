...
from lineas_por_clase.core.constantes import CORCHETES
from lineas_por_clase.models.nodos import InformacionExpresion
...
class BuscarYExtraerAnidados:
    ...
    def _buscar_ternarios_anidados(self, codigo: str) -> List[InformacionExpresion]:
        ...
        """
        from lineas_por_clase.core.analizadores.analizador_ternario import AnalizadorTernario
