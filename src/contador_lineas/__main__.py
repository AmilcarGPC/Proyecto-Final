...
def procesar_argumentos() -> argparse.Namespace:
    ...
    analizador.add_argument(
        "--version",
        action="version",
        version=f"contador_lineas {__version__}",
    ...
    analizador.add_argument(
        ...
        default="db/metricas_registro.json"
    )
...
def procesar_archivo(
    ...
    resultado = analizador.analizar_archivo(
        ruta_archivo,
        nombre_archivo,
        ruta_almacenamiento)
...
def main() -> None:
    ...
    try:
        ...
        procesar_archivo(args.ruta_archivo, args.dev_db_path, almacen, args.t)
