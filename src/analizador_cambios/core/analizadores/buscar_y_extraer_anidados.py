...
from analizador_cambios.core.constantes import CORCHETES
from analizador_cambios.models.nodos import InformacionExpresion
...
class BuscarYExtraerAnidados:
    ...
    def _buscar_ternarios_anidados(self, codigo: str) -> List[InformacionExpresion]:
        ...
        """
        from analizador_cambios.core.analizadores.analizador_ternario import AnalizadorTernario
